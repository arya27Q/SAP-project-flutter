...
class _FloatingWindowWidgetState extends State<FloatingWindowWidget> {
  ...
  Widget build(BuildContext context) {
    return AnimatedPositioned(
      duration: Duration(milliseconds: isDragging ? 0 : 350),
      ...
      // 🔥 FIX: Tingginya diubah jadi 48.0 biar border 3 pixelnya muat
      height: isMaximized ? null : (isMinimized ? 48.0 : windowHeight),
            ...
            child: Column(
              children: [
                ...
                GestureDetector(
                  ...
                  child: Container(
                    height: 45, // Header tetap 45 pixel
