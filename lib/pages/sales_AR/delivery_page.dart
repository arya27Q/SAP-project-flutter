...
class _DeliveryPageState extends State<DeliveryPage>
  ...
  return DataRow(
    cells: [
      ...
      _buildModernTableCell("inventory_uom_$index", initial: "0.00"),
 ...
 DataCell _buildModernTableCell(String key, {String initial = ""}) {
  ...
  return [
    ...
    const DataColumn(label: Text("Account", style: headerStyle)),
    ...
    const DataColumn(label: Text("Material Cost", style: headerStyle)),
  ];
}
    ...
    child: Column(children: [
      ...
      Expanded(child: ListView(
        ...
        children: [
          ...
          _buildModernFieldRow("Delivery To", "cfg_up"), const SizedBox(height: 12),
          _buildChooseFromListField("Series Draft", "cfg_series", [""]), const SizedBox(height: 12),
          _buildChooseFromListField("No Do ", "cfg_no_do", [""]), const SizedBox(height: 12),
