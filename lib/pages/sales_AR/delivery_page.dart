...
List<DataColumn> _buildStaticColumns() {
  return const [
    ...
    DataColumn(label: Text("In Stock.", style: TextStyle(fontSize: 11, fontWeight: FontWeight.bold))), 
    ...
    DataColumn(label: Text("Ordered Qty", style: TextStyle(fontSize: 11, fontWeight: FontWeight.bold))), 
    DataColumn(label: Text("Open_Qty", style: TextStyle(fontSize: 11, fontWeight: FontWeight.bold))), 
    DataColumn(label: Text("Quantity", style: TextStyle(fontSize: 11, fontWeight: FontWeight.bold))), 
    DataColumn(label: Text("Whse", style: TextStyle(fontSize: 11, fontWeight: FontWeight.bold))), 
    DataColumn(label: Text("Inventory UoM", style: TextStyle(fontSize: 11, fontWeight: FontWeight.bold))), 
    ...
    DataColumn(label: Text("G/L Account", style: TextStyle(fontSize: 11, fontWeight: FontWeight.bold))), 
    DataColumn(label: Text("UoM Code", style: TextStyle(fontSize: 11, fontWeight: FontWeight.bold))), 
    DataColumn(label: Text("No Code", style: TextStyle(fontSize: 11, fontWeight: FontWeight.bold))), 
    DataColumn(label: Text("Project Line", style: TextStyle(fontSize: 11, fontWeight: FontWeight.bold))), 
    DataColumn(label: Text("Material From", style: TextStyle(fontSize: 11, fontWeight: FontWeight.bold))), 
