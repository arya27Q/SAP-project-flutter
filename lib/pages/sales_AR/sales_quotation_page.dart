...
class _SalesQuotationPageState extends State<SalesQuotationPage> with SingleTickerProviderStateMixin {
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          if (showSidePanel)
            Positioned(top: 0, right: 0, bottom: 0, child: _buildFloatingSidePanel()),
        ],
      ),
    );
  }
          ...
          children: [
            ...
            PopupMenuButton<String>(
              ...
              itemBuilder: (BuildContext context) => [
                const PopupMenuItem(value: "item_no", child: Text("Item No.", style: TextStyle(fontSize: 11))),
                const PopupMenuItem(value: "desc", child: Text("Description", style: TextStyle(fontSize: 11))),
                const PopupMenuItem(value: "qty", child: Text("Quantity > 0", style: TextStyle(fontSize: 11))),
                const PopupMenuDivider(), 
                const PopupMenuItem(value: "reset", child: Text("Reset Filter", style: TextStyle(fontSize: 11, color: Colors.red))),
              ],
              child: Container(
            ...
            ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(backgroundColor: primaryIndigo, shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(6))),
            ...
            OutlinedButton.icon(
              ...
              style: OutlinedButton.styleFrom(backgroundColor: Colors.green, side: BorderSide.none, shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(6))),
            ),
            const SizedBox(width: 8),
            
            OutlinedButton.icon(
              onPressed: () { if (_rowCount > 1) setState(() => _rowCount--); },
...
List<DataColumn> _buildStaticColumns() {
  return const [
    ...
    DataColumn(label: Text("Item No.", style: TextStyle(fontSize: 11, fontWeight: FontWeight.bold))), 
    DataColumn(label: Text("Jenis Barang dan Jasa", style: TextStyle(fontSize: 11, fontWeight: FontWeight.bold))), 
    DataColumn(label: Text("Item Description", style: TextStyle(fontSize: 11, fontWeight: FontWeight.bold))), 
    DataColumn(label: Text("Jenis Item", style: TextStyle(fontSize: 11, fontWeight: FontWeight.bold))), 
    DataColumn(label: Text("Klasifikasi Orbit", style: TextStyle(fontSize: 11, fontWeight: FontWeight.bold))), 
    DataColumn(label: Text("Item Details", style: TextStyle(fontSize: 11, fontWeight: FontWeight.bold))), 
    DataColumn(label: Text("Quantity", style: TextStyle(fontSize: 11, fontWeight: FontWeight.bold))), 
    DataColumn(label: Text("Quantity Stock", style: TextStyle(fontSize: 11, fontWeight: FontWeight.bold))), 
    DataColumn(label: Text("Unit Price", style: TextStyle(fontSize: 11, fontWeight: FontWeight.bold))), 
    DataColumn(label: Text("Price Service", style: TextStyle(fontSize: 11, fontWeight: FontWeight.bold))), 
    DataColumn(label: Text("Price Reference", style: TextStyle(fontSize: 11, fontWeight: FontWeight.bold))), 
    DataColumn(label: Text("UoM Name", style: TextStyle(fontSize: 11, fontWeight: FontWeight.bold))), 
    DataColumn(label: Text("Free Text", style: TextStyle(fontSize: 11, fontWeight: FontWeight.bold))), 
    DataColumn(label: Text("Project Line", style: TextStyle(fontSize: 11, fontWeight: FontWeight.bold))), 
    DataColumn(label: Text("LineID", style: TextStyle(fontSize: 11, fontWeight: FontWeight.bold))), 
    DataColumn(label: Text("Discount %", style: TextStyle(fontSize: 11, fontWeight: FontWeight.bold))), 
        ...
        child: Row(
          ...
          children: [
            ...
            SizedBox(
              ...
              child: Column(
                children: [
                  _buildSummaryRowWithAutoValue("Total Before Discount", "0.00"),
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        ...
                        Expanded(child: _buildSummaryBox("0.00", isReadOnly: true)),
                      ],
                    ),
                  ),
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                            ...
                            children: [
                              SizedBox(
                                ...
                                child: Checkbox(
                                  ...
                                  onChanged: (v) => setState(() => _checkStates["cb_rounding"] = v!)
                                )
                              ),
                              const SizedBox(width: 4),
                        ...
                        Expanded(child: _buildSummaryBox("IDR 0.00", isReadOnly: true)),
                      ],
                    ),
                  ),
                  ...
                  _buildSummaryRowWithAutoValue("Total", "IDR 0.00", isBold: true),
...
Widget _buildSAPActionButton(String label, {
...
Widget _buildSummaryRowWithAutoValue(String label, String value, {bool isBold = false}) {
  return Padding(
    padding: const EdgeInsets.symmetric(vertical: 2),
    child: Row(
      children: [
        ...
        Expanded(child: _buildSummaryBox(value, isReadOnly: true, isBold: isBold)),
      ],
    ),
  );
}
...
Widget _buildSummaryBox(String val, {bool isBold = false, bool isReadOnly = true}) {
  return Container(
    height: 24,
    ...
    child: Text(val, style: TextStyle(fontSize: 12, fontWeight: isBold ? FontWeight.bold : FontWeight.normal)),
  );
}
  ...
  Widget _buildModernFieldRow(String label, String key, {bool isTextArea = false, String initial = ""}) {
    return Padding(
      ...
      child: Row(
        children: [
          SizedBox(width: 140, child: Text(label, style: TextStyle(fontSize: 12, color: secondarySlate, fontWeight: FontWeight.w500))),
          Expanded(
            child: Container(
  ...
  Widget _buildModernNoFieldRow(String label, String dropdownKey, List<String> seriesOptions, String textKey, {String initialNo = ""}) {
  return Padding(
    padding: const EdgeInsets.only(bottom: 8),
    child: Row(
      children: [
        SizedBox(width: 140, child: Text(label, style: TextStyle(fontSize: 11, color: secondarySlate, fontWeight: FontWeight.w500))),
              ...
              Container(
                ...
                child: DropdownButtonHideUnderline(
                  child: DropdownButton<String>(
                    ...
                    isDense: true,
                    style: const TextStyle(fontSize: 11, color: Color.fromARGB(255, 45, 45, 45), fontWeight: FontWeight.normal),
  ...
  Widget _buildModernTabNavigation() {
    return Container(
      ...
      child: TabBar(
        ...
        tabs: const [Tab(text: "Contents"), Tab(text: "Logistics"), Tab(text: "Accounting"), Tab(text: "Attachments")],
      ),
    );
  }
  ...
  Widget _buildFloatingSidePanel() {
    return Container(
      ...
      child: Column(
        children: [
          AppBar(
            backgroundColor: primaryIndigo, elevation: 0,
            title: const Text("Sales Order", style: TextStyle(color: Colors.white, fontSize: 14)),
            automaticallyImplyLeading: false,
            actions: [IconButton(onPressed: () => setState(() => showSidePanel = false), icon: const Icon(Icons.close, color: Colors.white))],
          ),
          Expanded(
            child: ListView(
              padding: const EdgeInsets.all(16),
              children: [
                ...
                _buildSmallDropdownRowModern("Punching", "cfg_punch", ["No", "Yes", "N/A"]),
                _buildSmallDropdownRowModern("Bending", "cfg_bend", ["No", "Yes", "N/A"]),
                _buildSmallDropdownRowModern("Assy", "cfg_assy", ["No", "Yes", "N/A"]),
                _buildSmallDropdownRowModern("SubCont", "cfg_sub", ["No", "Yes", "N/A"]),
                ...
                _buildChooseFromListField("Kode Faktur Pajak", "cfg_tax_code", ["010", "020"]),
                _buildModernFieldRow("Area", "cfg_area"),
                _buildChooseFromListField("Kategori SO", "cfg_cat", ["SO Resmi", "SO Sample"]),
                ...
                ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(backgroundColor: Colors.green, minimumSize: const Size(double.infinity, 45), shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(8))),
  ...
  Widget _buildChooseFromListField(String label, String key, List<String> data) {
  return Padding(
    padding: const EdgeInsets.only(bottom: 6),
    child: Row(
      children: [
              ...
              children: [
                Expanded(
                  child: Padding(
                    ...
                    child: Text(
                      _getCtrl(key).text.isEmpty ? data.first : _getCtrl(key).text, 
                      style: const TextStyle(fontSize: 12)
                    )
                  )
                ),
                InkWell(
                  onTap: () => _showSearchModal(label, key, data), 
                  child: Container(
                    width: 30, 
                    // GANTI .withOpacity(0.5) JADI .withValues(alpha: 0.5)
  ...
  void _showSearchModal(String title, String key, List<String> items) {
    showDialog(context: context, builder: (c) => AlertDialog(
      title: Text("Pilih $title"),
      content: SizedBox(width: 300, child: Column(mainAxisSize: MainAxisSize.min, children: items.map((e) => ListTile(dense: true, title: Text(e), onTap: () { setState(() => _getCtrl(key).text = e); Navigator.pop(context); })).toList())),
    ));
  }
}