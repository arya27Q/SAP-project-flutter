...
class _SalesQuotationPageState extends State<SalesQuotationPage>
    ...
    child: Row(
      ...
      children: [
        ...
        Expanded(flex: 4, child: Column(children: [
          _buildModernNoFieldRow("No.", "h_no_series", ["2025-COM", "2024-REG"], "h_no_val", initialNo: "256100727"),
          const SizedBox(height: 12),
          _buildModernFieldRow("Status", "h_stat", initial: "Open"),
          const SizedBox(height: 12),
          _buildModernFieldRow("Posting Date", "h_post", initial: "28/Dec/2025"),
          const SizedBox(height: 12),
          _buildModernFieldRow("Delivery Date", "h_deliv"),
          const SizedBox(height: 12),
          _buildModernFieldRow("Document Date", "h_doc", initial: "28/Dec/2025"),
        ])),
      ],
    ),
  );
          ...
          child: Row(
            ...
            children: [
              ...
              SizedBox(width: 350, child: Column(children: [
                _buildSummaryRowWithAutoValue("Total Before Discount", "f_before_disc"),
                ...
                _buildSummaryRowWithAutoValue("Total", "f_total_final", isBold: true, isReadOnly: true),
              ])),
            ],
          ),
        ),
  ...
  Widget _buildDiscountRow() => Padding(
    ...
    child: Row(children: [
      ...
      SizedBox(width: 60, child: _buildSummaryBox("f_disc_pct", isPercent: true, defaultValue: "0")),
  ...
  Widget _buildRoundingRow() => Padding(
    ...
    child: Row(crossAxisAlignment: CrossAxisAlignment.center, children: [
      SizedBox(width: 120, child: Row(children: [
        SizedBox(width: 24, height: 24, child: Checkbox(value: _checkStates["cb_rounding"] ?? false, onChanged: (v) => setState(() => _checkStates["cb_rounding"] = v!))),
        const SizedBox(width: 8),
        const Text("Rounding", style: TextStyle(fontSize: 12, color: Color(0xFF64748B), fontWeight: FontWeight.w500)),
      ])),
      const SizedBox(width: 58),
      Expanded(child: _buildSummaryBox("f_rounding", isReadOnly: !(_checkStates["cb_rounding"] ?? false))),
    ]),
  );
    ...
    return Padding(
      ...
      child: Row(children: [
        ...
        Expanded(child: Container(
          ...
          child: TextField(
            controller: controller, readOnly: isReadOnly, textAlign: TextAlign.right,
  ...
  Widget _buildSummaryBox(String key, {String defaultValue = "0.00", bool isReadOnly = false, bool isPercent = false}) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(color: isReadOnly ? bgSlate : Colors.white, border: Border.all(color: borderGrey), borderRadius: BorderRadius.circular(4)),
      child: TextField(
        controller: controller, readOnly: isReadOnly, textAlign: TextAlign.right, style: const TextStyle(fontSize: 12),
  ...
  Widget _buildModernNoFieldRow(String label, String dropdownKey, List<String> seriesOptions, String textKey, {String initialNo = ""}) => Padding(
    ...
    child: Row(crossAxisAlignment: CrossAxisAlignment.center, children: [
      ...
      Expanded(child: Container(
        ...
        child: Row(children: [
          Container(
            width: 110, height: 32, padding: const EdgeInsets.symmetric(horizontal: 8),
            ...
            child: DropdownButtonHideUnderline(child: DropdownButton<String>(
              value: _dropdownValues[dropdownKey] ?? seriesOptions.first, isDense: true,
