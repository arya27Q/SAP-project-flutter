...
class InventoryPostingPage extends StatefulWidget {
  const InventoryPostingPage({super.key});

  @override
  State<InventoryPostingPage> createState() => _InventoryPostingPageState();
}

class _InventoryPostingPageState extends State<InventoryPostingPage>
  ...
  void initState() {
    super.initState();
    // Di gambar pakai 1 tab General (atau bisa dihapus tabnya, tapi biar konsisten layout kita pertahankan)
  ...
  // ==========================================
  // WIDGET MAIN HEADER (Inventory Posting)
  // ==========================================
  Widget _buildModernHeader() => Container(
        ...
        child: Row(
          ...
          children: [
            // KIRI (Sesuai Screenshot Posting)
            Expanded(
              flex: 6,
              child: Column(
                children: [
                  _buildHeaderDate(
                      "Posting Date", "h_post_date", "30/December/2024"),
                  // Row Count Date & Time
                  Padding(
                    ...
                    child: Row(
                      children: [
                        ...
                        Expanded(
                          flex: 3,
                          child: _buildTextInputOnly("h_time", "14:59"),
                        ),
                      ],
                    ),
                  ),
                  _buildSmallDropdownRowModern("Price Source", "h_price_source",
                      ["Item Cost", "Last Evaluated Price"]),
                ],
              ),
            ),
            const SizedBox(width: 60),
            // KANAN (Sesuai Screenshot Posting)
            Expanded(
              flex: 4,
              child: Column(
                children: [
        ...
        Container(
          ...
          child: Row(
            children: [
              ...
              const SizedBox(width: 8),
              SizedBox(width: 150, child: _buildTextInputOnly("t_find", "")),
  ...
  // 🔥 KOLOM UNTUK INVENTORY POSTING (Sesuai Gambar)
  List<DataColumn> _buildStaticColumns() {
    ...
    return [
      ...
      centeredHeader("Qty In PCS"),
      centeredHeader("Variance %"),
      centeredHeader("Price"),
      centeredHeader("Total"),
      centeredHeader("Inventory Offset - Increase A..."),
    ];
  }

  // 🔥 ROW UNTUK INVENTORY POSTING
  DataRow _buildDataRow(int index) {
    return DataRow(
      cells: [
        ...
        _buildTableCell("qty_in_pcs_$index", initial: "0.00", isNumeric: true),
        _buildTableCell("var_pct_$index", initial: "0.00", isNumeric: true),
        _buildTableCell("price_$index", initial: "0.00", isNumeric: true),
        _buildTableCell("total_$index", initial: "0.00", isNumeric: true),
        _buildSearchableCell("offset_acc_$index"),
      ],
    );
  }
  ...
  // ==========================================
  // WIDGET FOOTER (Sesuai Inventory Posting)
  // ==========================================
    ...
    return Column(
      children: [
          ...
          child: Row(
            ...
            children: [
              Expanded(
                ...
                child: Column(
                  children: [
                    _buildModernFieldRow("Remarks", "f_rem",
                        isTextArea: true,
                        initial:
                            "Hasil STO Letrus...\nBased On Inventory Counting 247500020"),
                    _buildModernFieldRow("Journal Remark", "f_jrnl",
        ...
        Padding(
          ...
          child: Row(
            children: [
              _buildSAPActionButton("OK", isPrimary: true),
              const SizedBox(width: 8),
              ...
              const SizedBox(width: 8),
              _buildSAPActionButton("Copy from Inventory Counting",
                  customColor: Colors.amber.shade700),
            ],
          ),
        ),
          ...
          children: [
            ...
            Expanded(
              child: ListView(
                ...
                children: [
                  _buildUDFDate("Posting Reference Date", "udf_date"),
                  const SizedBox(height: 12),
                  _buildUDFField("Posted By Name", "udf_checker"),
                  const SizedBox(height: 12),
    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          const SizedBox(width: 28),
          Expanded(child: _buildDateInputOnly(key, initial)),
        ],
      ),
    );
  }
