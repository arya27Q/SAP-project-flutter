...
class _GoodReceivePOPageState extends State<GoodReceiptPOPage>
  ...
  DataRow _buildDataRow(int index) {
    return DataRow(
      cells: [
        ...
        _buildSearchableCell("Qty_in_Kg_$index"),
        _buildSearchableCell("Qty_in_M2_$index"),
      ],
    );
  }
  ...
  List<DataColumn> _buildStaticColumns() {
    ...
    return [
      ...
      centeredHeader("Qty in Kg"),
      centeredHeader("Qty in  M2"),
    ];
  }
      ...
      children: [
        ...
        Expanded(
          child: ListView(
            ...
            children: [
              _buildModernFieldRow("Po number", "Po_cfu"),
              const SizedBox(height: 12),
              _buildModernFieldRow("Internal Memo", "In_memo"),
              const SizedBox(height: 8),
              _buildChooseFromListField("Create By", "Creat_b,", [""]),
              ...
              const SizedBox(height: 12),
              _buildSmallDropdownRowModern("Ar Fp Number", "Ar_Fp_num", [""]),
              const SizedBox(height: 12),
              _buildSmallDropdownRowModern(
                "Number Series Faktur",
                "Credit_series_faktur",
                [""],
              ),
              const SizedBox(height: 12),
              _buildSmallDropdownRowModern("Business Unit", "Business Unit", [
                "",
              ]),
              const SizedBox(height: 12),
              _buildModernFieldRow("Do Receipt Date", "DO_receipt"),
              ...
              const SizedBox(height: 12),
              _buildSmallDropdownRowModern("Status Data", "Status Data", [""]),
              const SizedBox(height: 12),
              _buildModernFieldRow("Jumlah Data Bon", "J_bon", isDecimal: true),
              const SizedBox(height: 12),
              _buildSmallDropdownRowModern("Status TTF", "sts_tf", [""]),

              const SizedBox(height: 12),
              _buildModernFieldRow("Sisa / Kurang", "sisa", isDecimal: true),
              const SizedBox(height: 12),
              _buildModernFieldRow("Series Draft", "series_D"),
              const SizedBox(height: 12),
              _buildModernFieldRow("No DO", "no_do"),
              const SizedBox(height: 12),
              _buildSmallDropdownRowModern("Kategori Complain", "Kat_comp", [
                "",
              ]),
              const SizedBox(height: 12),
